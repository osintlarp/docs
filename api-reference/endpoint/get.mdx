...
```bash cURL
curl -X POST http://your-server:5001/api/leak-search \
...
response = requests.post(
    "http://your-server:5001/api/leak-search",
...
const response = await fetch("http://your-server:5001/api/leak-search", {
  method: "POST",
  headers: {
